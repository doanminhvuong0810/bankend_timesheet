...
public class DataSourceConfig {
  ...
  public static final String PACKAGE_BASE = "com.example.timesheet";
  public static final String PACKAGE_REPO = PACKAGE_BASE + ".repo";
  public static final String PACKAGE_ENTITY = PACKAGE_BASE + ".entity";
