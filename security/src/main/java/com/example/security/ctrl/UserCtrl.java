...
//  @PutMapping(value = "/{id}")
  ...
  @ResponseStatus(HttpStatus.OK)
  public SuccessResponse updateAllFields(@RequestParam("id") String id, @Valid @RequestBody UpdateUserRequest user) throws NotFoundException {
...
//    return userRepNoo.findByNameIgnoreCase(name);
